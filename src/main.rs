...
use esp_idf_hal::{
    delay::{Ets, FreeRtos},
    gpio::*,
    spi::{config::Config, SpiDeviceDriver, SpiDriver, SpiDriverConfig, SPI2, SPI3},
};
...
fn main() -> anyhow::Result<()> {
    ...
    let spi2 = SpiDriver::new(spi2, sclk, sdo, None::<AnyIOPin>, &SpiDriverConfig::new())?;

    let spi3 = SpiDriver::new(spi3, aclk, adi, None::<AnyIOPin>, &SpiDriverConfig::new())?;
